...
class Game:
    def __init__(self):
        ...
        self.sprites = []
        self.running = True
        self.game_over_text = self.canvas.create_text(250, 250, text = 'YOU WIN!!', font=("IPAexGothic", 50), state='hidden')
...
class UpPlatformSprite(PlatformSprite):
    def __init__(self, game, photo_image, x, y, width, height, ng=False):
        PlatformSprite.__init__(self, game, photo_image, x, y, width, height)
        self.ng = ng
        self.y = -2
...
if __name__ == '__main__':
    ...
    platform6 = PlatformSprite(g, PhotoImage(file='stickman/platform1.gif'), 50, 300, 100, 10)
